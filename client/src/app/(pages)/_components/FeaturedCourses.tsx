...
const CourseSection = ({
    ...
    return (
        <section className="py-16">
            <div className={`container mx-auto px-4 max-w-7xl overflow-x-hidden  ${containerClassName}`}>
                <div className="flex items-center gap-2 mb-8">
                    <Icon className="h-7 w-7 text-red-500" />
                    <div>
                        <h2 className={`text-3xl font-bold text-gray-900 ${headingClassName}`}>
                            {title}
                        </h2>
    ...
    const sections = [
        {
            ...
            subtitle: 'Explore our carefully curated selection of outstanding courses designed to help you excel',
            icon: Award,
            data: data?.featured
        },
        {
            ...
            subtitle: 'Discover the courses that our students love most and join the learning revolution',
            icon: BarChart3,
            data: data?.popular
        },
        {
            key: 'trending',
            title: 'Trending Now',
            subtitle: 'Stay ahead of the curve with our most in-demand and current courses',
            icon: TrendingUp,
            data: data?.trending
        },
        {
            key: 'bestseller',
            title: 'Bestsellers',
            subtitle: 'Experience our top-performing courses that have helped thousands succeed',
            icon: BookOpen,
        ...
        },
        {
            key: 'free',
            title: 'Free Courses',
            subtitle: 'Start your learning journey with our collection of high-quality free courses',
            icon: Gift,
            data: data?.free
        }
    ];
