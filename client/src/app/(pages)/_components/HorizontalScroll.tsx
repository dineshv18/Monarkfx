...
export default function Home() {
  ...
  return (
    <main className="relative bg-gradient-to-t from-zinc-900/95 to-black/95  text-white overflow-hidden min-h-screen">
      ...
      >
        {/* Enhanced Background Elements - only on desktop */}
        {!isMobile && (
          ...
          <div>
            ...
            <div className="text-center mb-16 md:mb-20">
              <div className="inline-flex items-center bg-gradient-to-r from-green-950/80 to-emerald-950/80 backdrop-blur-md border border-green-700/50 px-6 py-2 rounded-full mb-6 hover:border-green-500/70 transition-all duration-500 group">
                ...
                {/* Remove animated dot for mobile */}
                {!isMobile && (
                  <motion.div
              ...
              {/* Main hero text - animated on desktop, static on mobile */}
              {isMobile ? (
                <h2 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold mb-6 text-white leading-tight">
                  Master the{" "}
                  <span className="text-transparent bg-clip-text bg-gradient-to-r from-green-400 via-emerald-500 to-teal-400 inline-block">
                    Markets
                  </span>
                </h2>
              ) : (
              ...
              {/* Remove animated divider for mobile */}
              {!isMobile && (
                <motion.div
                  variants={itemVariants}
              ...
              <div className="relative bg-gradient-to-br from-gray-900/90 via-green-950/30 to-emerald-950/20 backdrop-blur-xl border border-green-700/30 rounded-2xl p-8 md:p-12 hover:border-green-500/50 transition-all duration-700 group-hover:shadow-2xl group-hover:shadow-green-500/10">
                <div className="grid md:grid-cols-3 gap-12">
                  <div className="md:col-span-2 space-y-8">
                    {/* Animated subheading - only on desktop */}
                    {isMobile ? (
                      <h3 className="text-3xl md:text-4xl font-bold text-white leading-tight">
                        Transform Your
                        <span className="text-transparent bg-clip-text bg-gradient-to-r from-green-400 via-emerald-500 to-teal-400 ml-3 inline-block">
                          Trading Journey
                        </span>
                      </h3>
                    ) : (
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                      {[
                        ...
                        >
                          <div className="flex-shrink-0 text-green-400 bg-green-500/10 w-7 h-7 rounded-full flex items-center justify-center mt-0.5 border border-green-500/30 group-hover/item:border-green-400/60 group-hover/item:bg-green-500/20 transition-all duration-300">
                            <svg
                              className="w-4 h-4"
                              fill="currentColor"
                              viewBox="0 0 20 20"
                    ...
                    {/* Button - static on mobile, animated on desktop */}
                    {isMobile ? (
                      <button
                  ...
                  {/* 3D Visual - animated on desktop, static on mobile */}
                  <div className="flex items-center justify-center">
                    {isMobile ? (
                      <div className="relative w-48 h-48 md:w-56 md:h-56">
                        <div className="absolute -inset-8 rounded-full bg-gradient-to-br from-green-500/20 via-emerald-500/10 to-teal-500/5 blur-2xl" />
                        {[0, 1, 2, 3, 4].map((index) => (
                          <div
                            key={index}
