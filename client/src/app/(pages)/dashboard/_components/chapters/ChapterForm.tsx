...
const STORAGE_BASE_URL = `https://res.cloudinary.com/${process.env.NEXT_PUBLIC_CLOUDINARY_CLOUD_NAME}`;
...
export function ChapterForm({
  ...
  const validAudioUrl =
    audioFullUrl && isValidUrl(audioFullUrl) ? audioFullUrl : null;
          ...
          {/*  <div className="space-y-4 grid md:grid-cols-2 gap-6">
            <div className="space-y-3">
              ...
              <FileUpload
                ...
                value={
                  pdfFile ||
                  (hasPdfFile && chapter?.pdfUrl !== "null"
                    ? chapter?.pdfUrl || null
                    : null)
                }
                onChange={(file) => {
            ...
            <div className="space-y-3">
                  ...
                  <div className="p-3 bg-muted/40 rounded-md mb-2">
                    <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2">
                      <div className="flex items-center gap-2 max-w-full sm:max-w-[60%]">
                        ...
                        <span className="text-sm font-medium truncate">
                          {getFileName(chapter.audioUrl)}
                        </span>
                      </div>
                      <div className="flex items-center gap-2">
                        <Badge
                          variant="outline"
                          className="bg-green-50 shrink-0"
                        >
                          Existing
                        </Badge>
                        {validAudioUrl ? (
              ...
              <FileUpload
                ...
                value={
                  audioFile ||
                  (hasAudioFile && chapter?.audioUrl !== "null"
                    ? chapter?.audioUrl || null
                    : null)
                }
                onChange={(file) => {
