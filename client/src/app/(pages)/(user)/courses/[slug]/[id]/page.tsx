      ...
      <div className="min-h-screen flex items-center justify-center bg-white px-4 py-12 font-plus-jakarta-sans">
        ...
        <div className="relative z-10 max-w-md w-full space-y-8 text-center">
          <div className="bg-white border border-[#E8E8E8] rounded-2xl shadow-[var(--shadow-soft)] overflow-hidden backdrop-blur-sm">
            <div className="bg-[#FBF6E9] border-b border-[#E8E8E8] p-8">
              <div className="flex justify-center mb-6">
                <div className="p-4 bg-[#E8B923] rounded-full">
            ...
            <div className="p-8 space-y-4">
              <div className="bg-[#FBF6E9] border border-[#E8E8E8] rounded-xl p-4">
                <p className="text-[#A07C16] text-sm">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
                <a
                  href="/courses"
                  className="w-full sm:w-auto px-6 py-3 bg-[image:var(--gold-metallic)] hover:brightness-95 text-[#0B1E3F] rounded-xl font-semibold shadow-lg transition-all duration-300 flex items-center justify-center gap-2"
                >
                ...
                <button
                  ...
                  className="w-full sm:w-auto px-6 py-3 bg-white border border-[#E8E8E8] hover:border-[#E8B923] text-[#4A4A4A] hover:text-[#E8B923] rounded-xl font-semibold transition-all duration-300 flex items-center justify-center gap-2"
                >
