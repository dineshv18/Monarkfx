...
const ChapterDetails: React.FC<ChapterDetailsProps> = ({ chapter }) => {
  ...
  return (
    <Card className="bg-gradient-to-br from-white to-red-50/30 overflow-hidden transition-all duration-300 group mx-auto relative shadow-lg">
      <CardHeader className="bg-gradient-to-r from-green-100/50 to-green-50/30 border-b border-green-100 py-8 px-8 font-plus-jakarta-sans">
        ...
        <CardTitle className="text-xl md:text-2xl font-bold text-gray-800 group-hover:text-green-700 transition-colors duration-300 leading-tight">
          {chapter.title}
        </CardTitle>
      </CardHeader>
