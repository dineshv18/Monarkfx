...
export const ReviewSection = ({
  ...
  return (
    <div className="space-y-6">
      ...
      >
        <div>
          <h2 className="text-3xl font-bold text-green-600">Course Reviews</h2>
        ...
        <DialogContent className="sm:max-w-md bg-gray-900">
          ...
          <div className="space-y-4 p-4">
            ...
            <Button
              ...
              className="w-full bg-green-600 hover:bg-green-700 text-white font-bold py-3 px-4 rounded-full"
            >
              {isSubmitting
                ? "Submitting..."
                : isEditMode
        ...
        >
          <AnimatePresence>
            {reviews.map((review, index) => (
              ...
              >
                <Card className="hover:shadow-lg transition-shadow bg-gray-900">
                  <CardHeader>
