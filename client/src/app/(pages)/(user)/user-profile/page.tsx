...
const StatCard = ({
  ...
  <div className="bg-gray-900 rounded-xl border border-green-500/20 shadow-sm hover:shadow-md transition-all duration-200 p-4">
          ...
          <section>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {enrollments.length === 0 ? (
                <Card className="col-span-full p-8 text-center border-dashed border-2 border-green-500/30">
